...
8 add 4 5	// сложить значения из 4 и 5 ячейки
			// и положить значение в четвертую ячейку
			// вид команды : 08 00 04 00 05
		
9 sub 4 5	// вычесть значения из 4 значение в 5 ячейке
			// и положить значение в четвертую ячейку
			// вид команды : 09 00 04 00 05		
			
15 stop		//  конец программы
